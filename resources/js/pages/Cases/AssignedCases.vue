...
import { Pencil, LucideTrash, SearchIcon, CheckCircle, XCircle } from 'lucide-vue-next';
    ...
    return [
        {
            ...
            icon: CheckCircle,
            onClick: () => {
                if (confirm(t('Are you sure you want to complete this case?'))) {
                    router.post(route('case-complete', { case: row.id }), {
                        final_review: prompt(t('Please enter your final review:')),
                    });
                }
            },
        },
        {
            ...
            icon: XCircle,
            onClick: () => {
                if (confirm(t('Are you sure you want to reject this case?'))) {
                    router.post(route('case-reject', { case: row.id }));
                }
            },
        },
    ];
