...
import { ExperienceDto, KeyValueDto, UserDto } from '@/types/generated';
...
<template>
    ...
    <AppLayout>
        <MemberRouteContent :member="member"  :title="$t('Experiences')">
            <div class="w-full">
    ...
    <Create  :member="member" v-if="crudCreateManagerRef.isModalOpen" :openModal="crudCreateManagerRef.isModalOpen" :employment_types="employment_types" :close="crudCreateManagerRef.close" />
    <Edit
