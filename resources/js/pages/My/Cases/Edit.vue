...
import UploadedPreview from '@/components/FileUpload/UploadedPreview.vue';
...
const form = useForm<PatientCaseRequestDto>(props.case)


const updateCase  = () => {
    form.post(route('my-cases-update',{
            case: props.case.id
    }), {
        onSuccess: () => {
            form.reset();
            ...
            <ContainerBox>
                 <template #header-left>
                        <h2 class="text-lg font-medium">
                            {{ $t('Edit case : ') }}  {{ props.case.case_code }}
                        </h2>
                 </template>
                 <template #header-right>
                      <Button variant="outline" size="sm" @click="updateCase">
                        {{ $t('Update') }}
                      </Button>
                 </template>
                 <template #content-table>
                     <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                         ...
                         <div class=" md:col-span-2 lg:col-span-3 mr-10">
                             ...
                             <UploadedPreview :file="props.case.uploaded_attachments" />
