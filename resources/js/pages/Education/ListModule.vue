...
<template>
    ...
    <Create v-if="crudCreateManagerRef.isModalOpen" :openModal="crudCreateManagerRef.isModalOpen" :close="crudCreateManagerRef.close" />
    <Edit
